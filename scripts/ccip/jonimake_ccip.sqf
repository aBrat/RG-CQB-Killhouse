...
getImpactPos        = compile preprocessFileLineNumbers  "scripts\ccip\getImpactPos.sqf";
getImpactPosRocket  = compile preprocessFileLineNumbers  "scripts\ccip\getImpactPosRocket.sqf";
getImpactPosBomb    = compile preprocessFileLineNumbers  "scripts\ccip\getImpactPosBomb.sqf";
...
ccip_start = {
  ...
  if(isPlayer (driver _plane) && ! ccip_hasEventHandler) then {
    currentPlane = _plane;
    _providerFileName =  "scripts\ccip\ccipProviders\" + (typeOf _plane + "_ccipProvider.sqf");
